...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_manufacturerUid_fkey" FOREIGN KEY ("manufacturerUid") REFERENCES "Manufacturer"("uid") ON DELETE RESTRICT ON UPDATE CASCADE;
